# -*- coding: utf-8 -*-
"""COMBINE_yolo_Sign_permodel.ipynb
Automatically generated by Colaboratory by Monika Mittal.

Original file is located at
    https://colab.research.google.com/drive/192y4gnFwAxYKdZ1BX4FuZwK5Ps4N3QG9
"""
...
!cp /content/drive/MyDrive/yoloSign1/data.yaml /content/drive/MyDrive/yoloSign3/
...
labels_per_document = {
    ...
    'f1120': {
        'page_number': 1,
        'labels': ["0 0.500625 0.846875 0.9578125 0.0671875", "1 0.49375 0.9109375 0.95859375 0.06015625"]

    },
    'f1120pc': {
        'page_number': 1,
        'labels': ["0 0.50375 0.740625 0.93578125 0.06328125", "1 0.4953125 0.8046875 0.9234375 0.06328125"],

    },
    'f1120ric': {
        'page_number': 1,
        'labels': ["0 0.500625 0.71015625 0.93671875 0.0640625", "1 0.49375 0.77265625 0.93671875 0.065625"],

    },
    'f3115': {
        'page_number': 1,
        'labels': ["0 0.50078125 0.8625 0.9359375 0.06171875", "1 0.50234375 0.91640625 0.93359375 0.0515625"],
...
def main():
    ...
    base_path = os.path.join(os.getcwd(), "yoloSign3")
    ...
    model_dir = base_path + "/detect4/weights/best.pt"
...
'''
for testing small part of the code
labels_per_document = {
    'fw4': {
        'page_number': 1,
        'labels': ["0 0.506875 0.77578125 0.9265625 0.0898125"]
...
labels_per_document = {
   'fw4_page_1.png'   : ["0 0.506875 0.77578125 0.9265625 0.0898125"],
   'f1120_page_1.png' : ["0 0.500625 0.846875 0.9578125 0.0671875","1 0.49375 0.9109375 0.95859375 0.06015625"],
   'f1120pc_page_1.png' : ["0 0.50375 0.740625 0.93578125 0.06328125","1 0.4953125 0.8046875 0.9234375 0.06328125"],
   'f1120ric_page_1.png' : ["0 0.500625 0.71015625 0.93671875 0.0640625","1 0.49375 0.77265625 0.93671875 0.065625"],
   'f3115_page_1.png' : ["0 0.50078125 0.8625 0.9359375 0.06171875","1 0.50234375 0.91640625 0.93359375 0.0515625"],
   'f8453_page_1.png' : []
}
'''
